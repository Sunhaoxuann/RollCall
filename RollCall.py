...
while True:
    ...
    if mode == 'main':#进入主窗口
        for enevt in events:
            if enevt.type == pg.MOUSEBUTTONDOWN and enevt.button == 1 and  event.pos[0] >= 354 and 31 >= event.pos[1]:#判断左键点击
                mode = 'login'
                ifclick = True
                times = 1
                ifchoice = False
            ...
            elif enevt.type == pg.MOUSEBUTTONDOWN and enevt.button == 1 and ifclick == True:#判断左键点击
                ifchoice = True
                break
